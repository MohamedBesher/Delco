...
namespace Saned.Delco.Admin.Controllers
{
    ...
    public class UserTripsController : BasicController
    {
        ...
        public ActionResult InProgress(string userId)
        {
            ViewBag.UserId = userId;
            PopulateCities();
            return PartialView("InProgress");
        }
        public ActionResult Canceled(string userId)
        {
            ViewBag.UserId = userId;
            PopulateCities();
        ...
        public ActionResult Delivered(string userId)
        {
            ViewBag.UserId = userId;
            PopulateCities();
        ...
        public async Task<ActionResult> Cancel(RefuseRequestViewModel search)
        {
            try
            {
                ...
                if (request.Status != RequestStatusEnum.Inprogress)
                    return RedirectToAction("InProgress", "Request").Error("لا يمكنك الغاء هذا الطلب .");
